...
// let bello = prompt('Eres bellisimo? S/N');
// if (bello = 'S') {
...
// let resultado = divisible = (numero / 2);

// alert('La division' + 'es' + resultado);

// function nosiDivisible(numero) {
//     if (numero / resultado == 0)
//         console.log(numero, 'Numero divisible'); {
//         return 'false'
//     }
// }
...
// let numeroCliente = prompt('inserta numero de cliente');
...
// let numeros = prompt('Ingresa dos numeros: ');
...
// var curso = prompt('Que programa quieres cursar?/Course/Carrera/Master');
